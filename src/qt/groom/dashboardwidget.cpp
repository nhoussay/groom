...
#include "qt/groom/forms/ui_dashboardwidget.h"
...
DashboardWidget::DashboardWidget(groomGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &groomGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
