...
const QString groomGUI::DEFAULT_WALLET = "~Default";

groomGUI::groomGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void groomGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    connect(toggleHideAction, &QAction::triggered, this, &groomGUI::toggleHidden);
...
void groomGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &groomGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &groomGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &groomGUI::showHide);
    connect(sendWidget, &SendWidget::showHide, this, &groomGUI::showHide);
    connect(receiveWidget, &ReceiveWidget::showHide, this, &groomGUI::showHide);
    connect(addressesWidget, &AddressesWidget::showHide, this, &groomGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::showHide, this, &groomGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::execDialog, this, &groomGUI::execDialog);
    connect(coldStakingWidget, &ColdStakingWidget::showHide, this, &groomGUI::showHide);
    connect(coldStakingWidget, &ColdStakingWidget::execDialog, this, &groomGUI::execDialog);
    connect(settingsWidget, &SettingsWidget::execDialog, this, &groomGUI::execDialog);
}


void groomGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
#ifndef Q_OS_MAC
...
void groomGUI::handleRestart(QStringList args)
{
...
void groomGUI::setClientModel(ClientModel* _clientModel)
{
    ...
    if (this->clientModel) {
        ...
        connect(clientModel, &ClientModel::message, this, &groomGUI::message);
...
void groomGUI::createTrayIconMenu()
{
#ifndef Q_OS_MAC
    ...
    connect(trayIcon, &QSystemTrayIcon::activated, this, &groomGUI::trayIconActivated);
#else
    // Note: On macOS, the Dock icon is used to provide the tray's functionality.
    MacDockIconHandler* dockIconHandler = MacDockIconHandler::instance();
    connect(dockIconHandler, &MacDockIconHandler::dockIconClicked, this, &groomGUI::macosDockIconActivated);
...
#ifndef Q_OS_MAC
void groomGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
#else
void groomGUI::macosDockIconActivated()
 {
     show();
     activateWindow();
 }
...
void groomGUI::changeEvent(QEvent* e)
{
    ...
    if (e->type() == QEvent::WindowStateChange) {
        if (clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray()) {
            ...
            if (!(wsevt->oldState() & Qt::WindowMinimized) && isMinimized()) {
                QTimer::singleShot(0, this, &groomGUI::hide);
                e->ignore();
            } else if ((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized()) {
                QTimer::singleShot(0, this, &groomGUI::show);
                e->ignore();
            }
        }
    }
...
void groomGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
void groomGUI::messageInfo(const QString& text)
{
...
void groomGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret)
{
...
bool groomGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
...
void groomGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if (!clientModel)
        return;
...
void groomGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void groomGUI::detectShutdown()
{
    if (ShutdownRequested()) {
        if (rpcConsole)
            rpcConsole->hide();
...
void groomGUI::goToSend()
{
    showTop(sendWidget);
}

void groomGUI::goToAddresses()
{
    showTop(addressesWidget);
}

void groomGUI::goToMasterNodes()
{
    showTop(masterNodesWidget);
}

void groomGUI::goToColdStaking()
{
    showTop(coldStakingWidget);
}

void groomGUI::goToSettings(){
    showTop(settingsWidget);
}

void groomGUI::goToSettingsInfo()
{
    navMenu->selectSettings();
...
void groomGUI::goToReceive()
{
    showTop(receiveWidget);
}

void groomGUI::openNetworkMonitor()
{
    settingsWidget->openNetworkMonitor();
}

void groomGUI::showTop(QWidget* view)
{
...
void groomGUI::changeTheme(bool isLightTheme)
{
...
void groomGUI::resizeEvent(QResizeEvent* event)
{
    // Parent..
...
bool groomGUI::execDialog(QDialog *dialog, int xDiv, int yDiv)
{
    return openDialogWithOpaqueBackgroundY(dialog, this);
}

void groomGUI::showHide(bool show)
{
...
int groomGUI::getNavWidth()
{
    return this->navMenu->width();
}

void groomGUI::openFAQ(SettingsFaqWidget::Section section)
{
    showHide(true);
...
#ifdef ENABLE_WALLET
bool groomGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    // Connect actions..
    connect(walletModel, &WalletModel::message, this, &groomGUI::message);
    connect(masterNodesWidget, &MasterNodesWidget::message, this, &groomGUI::message);
    connect(coldStakingWidget, &ColdStakingWidget::message, this, &groomGUI::message);
    connect(topBar, &TopBar::message, this, &groomGUI::message);
    connect(sendWidget, &SendWidget::message,this, &groomGUI::message);
    connect(receiveWidget, &ReceiveWidget::message,this, &groomGUI::message);
    connect(addressesWidget, &AddressesWidget::message,this, &groomGUI::message);
    connect(settingsWidget, &SettingsWidget::message, this, &groomGUI::message);

    // Pass through transaction notifications
    connect(dashboard, &DashboardWidget::incomingTransaction, this, &groomGUI::incomingTransaction);

    return true;
}

bool groomGUI::setCurrentWallet(const QString& name)
{
    // Single wallet supported.
    return true;
}

void groomGUI::removeAllWallets()
{
    // Single wallet supported.
}

void groomGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address)
{
...
static bool ThreadSafeMessageBox(groomGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
...
void groomGUI::subscribeToCoreSignals()
{
...
void groomGUI::unsubscribeFromCoreSignals()
{
