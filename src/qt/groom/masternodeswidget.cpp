...
#include "qt/groom/forms/ui_masternodeswidget.h"

#include "qt/groom/qtutils.h"
#include "qt/groom/mnrow.h"
#include "qt/groom/mninfodialog.h"
#include "qt/groom/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(groomGUI *parent) :
    PWidget(parent),
