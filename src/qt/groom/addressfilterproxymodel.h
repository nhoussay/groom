...
#ifndef groom_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define groom_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //groom_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
