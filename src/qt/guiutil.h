...
/** Utility functions used by the GROOM Qt UI.
 */
namespace GUIUtil
{
...
// Render GROOM addresses in monospace font
...
// Parse "groom:" URI into recipient object, return true on successful parsing
