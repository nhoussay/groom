...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizegroomAmount") || reset)
        gArgs.SoftSetArg("-anonymizegroomamount", settings.value("nAnonymizegroomAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in groom.cpp during shotdown to also remove the window positions
