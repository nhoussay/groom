...
extern const char * const groom_CONF_FILENAME;
extern const char * const groom_PID_FILENAME;
extern const char * const groom_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("groom-%s", name);
