...
The build script we'll be using is contained in the GROOM github repository ([contrib/gitian-build.py](https://github.com/groom-project/groom/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the GROOM repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/GROOM-Project/GROOM/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, groom-detached-sigs, and groom GitHub repos.
