...
The script [extract-osx-sdk.sh](https://github.com/groom-project/groom/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
groom/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/groom-project/groom/blob/master/doc/README_osx.md) for troubleshooting tips.