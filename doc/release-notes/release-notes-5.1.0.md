GROOM Core version v5.1.0 is now available from:  <https://github.com/groom-project/groom/releases>
...
- #2249 Make box of GROOM Send address return to purple when it's empty (PicklesRcool)
...
- #2170 Better groom.conf Masternode data error notification (furszy)
