...
from test_framework.groom_node import groomTestNode
...
class groom_ColdStakingTest(groomTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(groomTestNode())
