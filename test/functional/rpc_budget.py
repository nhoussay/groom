...
class BudgetProposalTest(groomTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid GROOM address")
        assert_raises_rpc_error(-5, "Invalid GROOM address", self.nodes[0].preparebudget,
