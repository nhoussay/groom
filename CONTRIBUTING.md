Contributing to GROOM Core
============================

The GROOM Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/groom-project/groom/blob/master/doc/translation_process.md)
...
The following applies to code changes to the GROOM Core project, and is not to be
confused with overall GROOM Network Protocol consensus changes.

Whether a pull request is merged into GROOM Core rests with the project merge
...
Patches that change GROOM consensus rules are considerably more involved than
...
Where a patchset proposes to change the GROOM consensus, it must have been
...
The project leader is the release manager for each GROOM Core release.
