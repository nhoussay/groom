...
This means one can have an always-on groomd instance running, and another local groomd/groom-qt instance which connects to this node and receives blocks from it.
