...
Failed to fetch the GROOM zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
GROOM - fetch-params.sh

This script will fetch the GROOM zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common GROOM zkSNARK parameters. Note that it is
